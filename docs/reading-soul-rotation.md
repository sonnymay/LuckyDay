# Reading Soul Audit — Rotation Tracker

Weekly Thursday audit. Pick one content pool per week, score on hope/specific/useful/almanac-voice/fun, rewrite 3 lowest-scoring strings.
...
After Week 5, restart at Week 1 (new audit on `src/lib/luck.ts`).
