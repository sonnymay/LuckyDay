...
const zodiacDetails: Record<string, { emoji: string; tone: string; dailyInsights: string[]; element: ZodiacElement; luckyNumbers: number[] }> = {
  Rat: {
    ...
    dailyInsights: [
      ...
      'A small change to your morning plan opens room for the better thing showing up by mid-afternoon. Stay loose.',
  ...
  Tiger: {
    ...
    dailyInsights: [
      ...
      'You walk into a room this morning and people pay attention before you speak. One direct question gets you what you came for.',
  ...
  Rabbit: {
    ...
    dailyInsights: [
      ...
      'Notice the small mood shift in the room before lunch — you read it correctly. Adjust your approach and the rest of the day flows.',
      'A slow start to the morning serves you better than rushing in. The first calm hour decides the next eight.',
  ...
  Dragon: {
    ...
    dailyInsights: [
      ...
      'The "yes" you have been practicing in your head — say it out loud before noon. The opening you wait for is the one you create.',
    ],
  },
  Snake: {
    element: 'Fire',
